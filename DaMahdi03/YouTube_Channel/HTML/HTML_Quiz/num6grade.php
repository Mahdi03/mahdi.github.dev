...
<?php
    ...
    $answer6A = $_POST['question-6A-answers'];
	$answer6B = $_POST['question-6B-answers'];
    
    if ($answer6A == "h6" && $answer6B == "/h6") {
...
?>
<meta http-equiv="refresh" content="3;url=html_question_7.html" />
</body>
</html>